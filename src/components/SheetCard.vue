        ...
        <b-card>
            <div class="float-left">
              ...
              <div>
                Class:
                <br />
                <b-form-input style="width: 30%" v-model="sheetCopy.class" type="text"></b-form-input>    
                <br />
              </div>
            </div>
        ...
        <b-card>
          <div style="display: flex;">
            <div>
              Bonus:
              <br />
              <b-form-input style="width: 30%" v-model="sheet.bonus" type="number"></b-form-input>
            </div>
            <div>
              Exp:
              <br />
          ...
          <div style="display: flex;">
            <div>
              AC:
              <br />
              <b-form-input style="width: 30%" v-model="sheet.armor_class" type="number"></b-form-input>
            </div>
            <div>
              Initiative:
              <br />
              <b-form-input style="width: 30%" v-model="sheet.initiative" type="number"></b-form-input>
            </div>
            <div>
              Speed:
              <br />
              <b-form-input style="width: 30%" v-model="sheet.speed" type="number"></b-form-input>
            </div>
          </div>
        </b-card>
        <b-card>
          <div style="display: flex;">
            <div>
              Strength:
              <br />
              <b-form-input style="width: 30%" v-model="sheet.strength" type="number"></b-form-input>
            </div>
            <div>
              Dexterity:
              <br />
              <b-form-input style="width: 30%" v-model="sheet.dexterity" type="number"></b-form-input>
            </div>  
            <div>
              Constitution:
              <br />
              <b-form-input style="width: 30%" v-model="sheet.constitution" type="number"></b-form-input>
            </div>
          </div>
          <div style="display: flex;">
            <div>
              Intelligence:
              <br />
              <b-form-input style="width: 30%" v-model="sheet.intelligence" type="number"></b-form-input>
            </div>
            <div>
              Wisdom:
              <br />
              <b-form-input style="width: 30%" v-model="sheet.wisdom" type="number"></b-form-input>
            </div>
            <div>
              Charisma:
              <br />
              <b-form-input style="width: 30%" v-model="sheet.charisma" type="number"></b-form-input>
            </div>
          </div>
        </b-card>
        <br />
        <b-button class="float-right" variant="danger" style="width: 25%">Save</b-button>
    </b-modal>
  </b-card>
</template>
